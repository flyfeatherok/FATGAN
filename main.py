...
def parse_args():
    desc = "Tensorflow implementation of FATGAN"
...
#    parser.add_argument('--datasetA_path', type=str, default='/media/siat-x/D896F32696F303B2/Datas/CelebA/CelebAMask-HQ/', help='datasetA_path')
    ...
    parser.add_argument('--batch_size', type=int, default=16, help='Batch size of each dataset')
    ...
    parser.add_argument('--msk_weight', type=float, default=10, help='Weight about Mask')

    parser.add_argument('--gan_type', type=str, default='wgan-gp', help='gan / lsgan / wgan-gp / wgan-lp / dragan / hinge')
    parser.add_argument('--sn', type=str2bool, default=False, help='sn')
    parser.add_argument('--rito', type=int, default=5, help='d/g rito')
    parser.add_argument('--scconv', type=str2bool, default=True, help='scconv')
    parser.add_argument('--skip', type=str2bool, default=True, help='skip-connection')
    
    parser.add_argument('--test_path', type=str, default='test_img', help='test images path')
    parser.add_argument('--CelebaA_attrs', type=str, nargs='+', help='selected attributes for the CelebA dataset',
                        default=['Male', 'Smiling', 'Brown_Hair'])#,'Young'

    parser.add_argument('--ch', type=int, default=64, help='base channel number per layer')
    parser.add_argument('--n_res', type=int, default=6, help='The number of adaptive_resblock')
